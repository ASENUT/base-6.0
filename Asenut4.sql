/*==============================================================*/
/* DBMS name:      MySQL 5.0                                    */
/* Created on:     2017/01/16 16:03:06                          */
/*==============================================================*/
...
drop table if exists PESO_PACIENTE;
...
drop table if exists REALIZADO;
...
(
   COD_HISTO_ALIMENTICIA int not null AUTO_INCREMENT,
   DESCRIPCION_ALIMENTICIA varchar(1000),
   primary key (COD_HISTO_ALIMENTICIA)
);
...
(
   COD_HISTO_COSMETOLOGICA int not null AUTO_INCREMENT,
   COD_MEDICAMENTO      int,
   COD_CIRUGIA          int,
   COD_ENFERMEDAD       int,
   COD_ALERGIAS         int,
   ...
   COD_                 int,
   COD_PEELING          int,
   primary key (COD_HISTO_COSMETOLOGICA)
);
...
(
   ...
   EXAMEN_LABORATORIO   varchar(800),
...
(
   ...
   DIRECCION_URL_ANTES  varchar(300) not null,
   DIRECCION_URL_DESPUES varchar(300),
...
(
   COD_PESO             int not null AUTO_INCREMENT,
   FECHA_TRATA          date,
   CEDULA               char(13),
   COD_TRATAMIENTO      int,
   FECHA_PESO           date not null,
   PESO_PACIENTE        float(5) not null,
   TRATAMIENTO          varchar(500) not null,
   OBSERVACIONES        varchar(500) not null,
   primary key (COD_PESO)
);
...
(
   ...
   COD_TRATAMIENTO      int not null,
   FECHA                date not null,
   primary key (COD_ANTROPOMETRICO, FECHA_TRATA, CEDULA, COD_TRATAMIENTO)
);
...
(
   COD_HISTO_ALIMENTICIA int not null,
   COD_HISTO_COSMETOLOGICA int not null,
   COD_HISTORIA         int not null,
   FECHA_CONSULTA       date not null,
   primary key (COD_HISTO_ALIMENTICIA, COD_HISTO_COSMETOLOGICA, COD_HISTORIA)
);
...
alter table HISTORIA_COSMETOLOGICA add constraint FK_RELATIONSHIP_37 foreign key (COD_)
      references OTROSPROBLEMAS (COD_) on delete restrict on update restrict;

alter table HISTORIA_COSMETOLOGICA add constraint FK_RELATIONSHIP_38 foreign key (COD_PEELING)
...
alter table PESO_PACIENTE add constraint FK_PESA foreign key (FECHA_TRATA, CEDULA, COD_TRATAMIENTO)
      references PACIENTE_TRATAMIENTO (FECHA_TRATA, CEDULA, COD_TRATAMIENTO) on delete restrict on update restrict;

alter table POSEE add constraint FK_POSEE2 foreign key (COD_ANTROPOMETRICO)
      references DATOS_ANTROPOMETRICOS (COD_ANTROPOMETRICO) on delete restrict on update restrict;

alter table POSEE add constraint FK_POSEE3 foreign key (FECHA_TRATA, CEDULA, COD_TRATAMIENTO)
      references PACIENTE_TRATAMIENTO (FECHA_TRATA, CEDULA, COD_TRATAMIENTO) on delete restrict on update restrict;

alter table REALIZADO add constraint FK_REALIZADO foreign key (COD_HISTORIA)
      references HISTORIA_CLINICA (COD_HISTORIA) on delete restrict on update restrict;

alter table REALIZADO add constraint FK_REALIZADO2 foreign key (COD_HISTO_ALIMENTICIA)
      references HISTORIA_ALIMENTICIA (COD_HISTO_ALIMENTICIA) on delete restrict on update restrict;

alter table REALIZADO add constraint FK_REALIZADO3 foreign key (COD_HISTO_COSMETOLOGICA)
      references HISTORIA_COSMETOLOGICA (COD_HISTO_COSMETOLOGICA) on delete restrict on update restrict;
